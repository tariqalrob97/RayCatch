...
public class plant extends SelTestCase {
	...
	private static void compareInsightsDataAndWriteResults(plant tmpPlant, plant previousPlantData) {
		...
		try {
			...
			DeltaString = previousPlantData.Disconnected_Strings_status.trim() == tmpPlant.Disconnected_Strings_status.trim();
			...
			DeltaString = previousPlantData.Panel_Degradation_status.trim() == tmpPlant.Panel_Degradation_status.trim();
			...
			DeltaString = previousPlantData.String_Data_integrity_status.trim() == tmpPlant.String_Data_integrity_status.trim();
			...
			DeltaString = previousPlantData.Temperature_Coefficient__status.trim() == tmpPlant.Temperature_Coefficient__status.trim();
			...
			DeltaString = previousPlantData.Inverter_Downtime__status.trim() == tmpPlant.Inverter_Downtime__status.trim();
			...
			DeltaString = previousPlantData.Inverter_Data_integrity_status.trim() == tmpPlant.Inverter_Data_integrity_status.trim();
			...
			DeltaString = previousPlantData.Inverter_Efficiency_Below_Spec_status.trim() == tmpPlant.Inverter_Efficiency_Below_Spec_status.trim();
			...
			DeltaString = previousPlantData.Late_Awakening_status.trim() == tmpPlant.Late_Awakening_status.trim();
			...
			DeltaString = previousPlantData.Mppt_status.trim() == tmpPlant.Mppt_status.trim();
			...
			DeltaString = previousPlantData.Inverter_Relative_Efficiency_status.trim() == tmpPlant.Inverter_Relative_Efficiency_status.trim();
			...
			DeltaString = previousPlantData.Clipping_status.trim() == tmpPlant.Clipping_status.trim();
			...
			DeltaString = previousPlantData.Power_Factor_status.trim() == tmpPlant.Power_Factor_status.trim();
			...
			DeltaString = previousPlantData.Temperature_Alert_status.trim() == tmpPlant.Temperature_Alert_status.trim();
			...
			DeltaString = previousPlantData.Frequency_Deviation_status.trim() == tmpPlant.Frequency_Deviation_status.trim();
			...
			DeltaString = previousPlantData.Voltage_Deviation_status.trim() == tmpPlant.Voltage_Deviation_status.trim();
